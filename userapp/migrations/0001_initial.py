    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, verbose_name='Username Field')),
                ('date_joined', models.DateTimeField(auto_now_add=True, verbose_name='Date Joined Field')),
